class SignupPage {
  go() {
    cy.visit("/"); //acesar a página alvo

    cy.get('a[href="/deliver"]').click();
    cy.get("#page-deliver form h1").should(
      "have.text",
      "Cadastre-se para  fazer entregas"
    ); //checkpoint para verificar que está no lugar correto
  }
  ...
  fillForm(deliver) {
    ...
    cy.get('input[accept^="image"]').selectFile(
      "/Users/pennacchi/Documents/cypress-qaninja/buger-eats/cypress/fixtures/images/cnh-digital.jpg",
      { force: true }
    );
  }
